...
const toggleStyle = ()=>{
  ...
  <div className="accordion-item">
    ...
    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div className="accordion-body" style={myStyle}>
        <strong>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Autem dignissimos unde, eius ducimus voluptatem quo sunt dolor. Deleniti, totam. Quidem sit optio autem dolor esse tempora dolorum laborum aperiam adipisci.</strong>
      </div>
    </div>
  </div>
  <div className="accordion-item">
